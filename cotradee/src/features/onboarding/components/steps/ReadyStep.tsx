...
export function ReadyStep() {
  ...
  return (
    <div className="w-full max-w-md mx-auto text-center">
      ...
      <button onClick={() => navigate('/dashboard', { replace: true })} className="mt-8 w-full rounded-xl bg-black dark:bg-white p-4 font-bold text-white dark:text-black flex items-center justify-center gap-2 hover:opacity-90 transition-all">Go to Dashboard <ArrowRight size={16} /></button>
    </div>
  );
}
