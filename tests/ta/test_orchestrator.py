...
async def test_fetch_sequence_success_primary_broker(orchestrator, mock_broker, mock_fallback_broker):
    ...
    result = await orchestrator._fetch_candles("EURUSD", Timeframe.H1, 100, mock_broker, user_id="test-user-001")
...
async def test_fetch_sequence_both_brokers_fail(orchestrator, mock_broker, mock_fallback_broker):
    ...
    result = await orchestrator._fetch_candles("EURUSD", Timeframe.M15, 50, mock_broker, user_id="test-user-001")
