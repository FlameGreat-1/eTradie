...
class ReutersRSSProvider(BaseNewsProvider):
    provider_name = "reuters_rss"
    ...
    async def fetch(self) -> list[NewsItem]:
        ...
        try:
            ...
            for entry in entries:
                ...
                items.append(
                    NewsItem(
                        ...
                        dedupe_hash=compute_dedupe_hash("reuters", entry.title),
                    ),
                )
            ...
            logger.error("reuters_rss_fetch_failed", error=str(exc))
            raise
