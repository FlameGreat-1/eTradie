...
class IntermarketSnapshotRow(Base):
    ...
    iron_ore: Mapped[float | None] = mapped_column(Float, nullable=True)
    dairy_gdt: Mapped[float | None] = mapped_column(Float, nullable=True)
    copper: Mapped[float | None] = mapped_column(Float, nullable=True)
    natural_gas: Mapped[float | None] = mapped_column(Float, nullable=True)
