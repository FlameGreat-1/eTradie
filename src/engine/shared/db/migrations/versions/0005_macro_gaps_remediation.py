...
def upgrade() -> None:
    ...
    op.add_column("cot_reports", sa.Column("leveraged_long", sa.Integer, nullable=False, server_default="0"))
    op.add_column("cot_reports", sa.Column("leveraged_short", sa.Integer, nullable=False, server_default="0"))
    op.add_column("cot_reports", sa.Column("leveraged_net", sa.Integer, nullable=False, server_default="0"))
    op.add_column("cot_reports", sa.Column("asset_manager_long", sa.Integer, nullable=False, server_default="0"))
    op.add_column("cot_reports", sa.Column("asset_manager_short", sa.Integer, nullable=False, server_default="0"))
    op.add_column("cot_reports", sa.Column("asset_manager_net", sa.Integer, nullable=False, server_default="0"))
    op.add_column("cot_reports", sa.Column("percentile_rank", sa.Float, nullable=False, server_default="50.0"))
    op.add_column("cot_reports", sa.Column("signal_strength", sa.String(20), nullable=False, server_default="NEUTRAL"))
    op.add_column("cot_reports", sa.Column("divergence_flag", sa.Boolean, nullable=False, server_default="false"))
    ...
    op.create_index("ix_econ_inflation_type", "economic_releases", ["inflation_type", "release_time"])

    # -- QE/QT metrics (Gap 7) --
    op.add_column("central_bank_events", sa.Column("policy_action", sa.String(10), nullable=False, server_default="NONE"))
    op.add_column("central_bank_events", sa.Column("balance_sheet_direction", sa.String(20), nullable=False, server_default=""))
    op.create_index("ix_cb_events_policy_action", "central_bank_events", ["policy_action", "event_timestamp"])
    ...
    op.add_column("dxy_snapshots", sa.Column("momentum", sa.String(15), nullable=False, server_default="FLAT"))
    op.add_column("dxy_snapshots", sa.Column("divergence_signals_json", postgresql.JSON, nullable=False, server_default="{}"))
