...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "document_version_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("rag_document_versions.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column("doc_type", sa.String(64), nullable=False),
    ...
    op.create_index(
        "ix_rag_scenarios_fw_setup_dir",
        "rag_scenarios",
        ["framework", "setup_family", "direction"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "document_version_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("rag_document_versions.id", ondelete="SET NULL"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "retrieval_log_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("rag_retrieval_logs.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "chunk_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("rag_chunks.id", ondelete="SET NULL"),
            nullable=True,
        ),
