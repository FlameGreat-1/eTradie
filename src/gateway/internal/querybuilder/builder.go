...
func (b *Builder) Build(
	...
	params := &models.RAGQueryParams{
		...
		HasSMCCandidates:   len(taResult.SMCCandidates) > 0 || taSignals.HasBMS || taSignals.HasOrderBlock || taSignals.HasFVG || taSignals.HasLiquiditySweep,
		HasSnDCandidates:   len(taResult.SnDCandidates) > 0 || taSignals.HasQML || taSignals.HasSRFlip || taSignals.HasRSFlip,
