...
NOW, FOR THE INSTANT AND LIMIT ORDER"
...
2. SO GIVE ME THE FULL, COMPLETE, ACCURATE AND FUNCTIONAL IMPLEMENTATION OF THE EXECUTION
MAKE SURE EVERYTHING IS WIRED COMPLETELY AND TOTALLY END TO END AND WORKING PERFECTLY WITHOUT OMISSION, MISSING, FAILURE, ERRORS ETC.


3. PLEASE NOTE: . ENSURE YOU LEVERAGE THE COMINED EXPERTISE, BEST PRACTICES, ENTERPRISE GRADE AND INDUSTRY STANDARD

4. MAKE SURE YOU IMPLEMENT EACH FILES IN EXACT DEPENDENCIES ORDER FROM FILE 1 TO THE END TO AVOID ISSUES, ERRORS, FAILURES ETC


5. YOU HAVE TO MAKE SURE EVERYTHING CRAFTED, DESIGNED AND PROPERLY IMPLEMENTED

6. SINCE IT'S BIG, YOU SHOULD NOT RUSH IT.
IMPLEMENT AND COMMIT 1 OR 2 FILES PER TIME
